...
// 非 Linux 平台的降级实现:系统指标不暴露(Linux 网关目标平台走 sys_linux.go)。
// 保留接口签名让 metrics.go 无 build 约束地调用。

func processRSS() (int64, bool)                          { return 0, false }
func systemMem() (memStat, bool)                         { return memStat{}, false }
func systemMemUsedPercent() (float64, bool)              { return 0, false }
func diskStats(paths ...string) map[string]diskStat      { return nil }
